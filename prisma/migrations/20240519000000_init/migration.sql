...
-- CreateEnum
CREATE TYPE "MovementType" AS ENUM ('IN', 'SALE', 'ADJUSTMENT', 'DAMAGE', 'TRANSFER_IN', 'TRANSFER_OUT');
...
-- CreateIndex
CREATE INDEX "Inventory_daysInInventory_idx" ON "Inventory"("daysInInventory");
